...
class ConfigBuilderFrame(customtkinter.CTkFrame):
    ...
    def _init_sub_editors(self):
        ...
        self.sheet_entry = customtkinter.CTkEntry(self.editor_fields, font=("Segoe UI", 11), width=160)
        self.sheet_entry.grid(row=2, column=1, sticky="w", padx=4, pady=6)
        ...
        self.range_a_entry = customtkinter.CTkEntry(self.editor_fields, font=("Segoe UI", 11), width=100)
        self.range_a_entry.grid(row=3, column=1, sticky="w", padx=4, pady=6)
        ...
        self.range_b_entry = customtkinter.CTkEntry(self.editor_fields, font=("Segoe UI", 11), width=100)
        self.range_b_entry.grid(row=4, column=1, sticky="w", padx=4, pady=6)
        ...
        self.chart_id_entry = customtkinter.CTkEntry(self.editor_fields, font=("Segoe UI", 11), width=100)
        self.chart_id_entry.grid(row=7, column=1, sticky="w", padx=4, pady=6)
